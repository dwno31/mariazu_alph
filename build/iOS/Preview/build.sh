#!/bin/bash
# This file was generated based on /usr/local/share/uno/Packages/UnoCore/1.2.2/targets/ios/build.sh.
...
##else
    xcodebuild -project "mariazu_alpha.xcodeproj" "$@" | tee >(checkForError)
##endif
