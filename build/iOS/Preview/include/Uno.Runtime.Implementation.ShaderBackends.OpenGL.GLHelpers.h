...
void GLHelpers__TexImage2DFromIntPtr_fn(int* target, int* w, int* h, int* mip, int* format, void** data);
...
struct GLHelpers : uObject
{
    ...
    static void TexImage2DFromIntPtr(int target, int w, int h, int mip, int format, void* data);
};
// }
