// This file was generated based on /usr/local/share/uno/Packages/Fuse.Scripting.JavaScriptCore/1.2.1/$.uno.
...
struct JSObjectRef
{
    ...
    static bool SetPrivate(::JSObjectRef __this, uObject* data);
    ...
    static bool op_Equality(::JSObjectRef o1, ::JSObjectRef o2);
