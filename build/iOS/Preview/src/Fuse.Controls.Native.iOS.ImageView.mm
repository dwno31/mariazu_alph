...
// internal sealed extern class ImageView :531
// {
static void ImageView_build(uType* type)
{
    ::STRINGS[0] = uString::Const("MultiDensityImageSource in a native context not supported");
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Controls.Native/1.2.1/ios/$.uno");
...
// public override sealed void Dispose() :585
...
// private static void SetTransform(ObjC.Object handle, float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24, float m31, float m32, float m33, float m34, float m41, float m42, float m43, float m44) :658
...
// private static void SetTransform(ObjC.Object handle, float4x4 t) :648
void ImageView__SetTransform3_fn(::g::ObjC::Object* handle, ::g::Uno::Float4x4* t)
{
    ImageView::SetTransform3(handle, *t);
}

// public void set_TintColor(float4 value) :555
void ImageView__set_TintColor_fn(ImageView* __this, ::g::Uno::Float4* value)
{
    __this->TintColor(*value);
}

// private static ObjC.Object TintImage(ObjC.Object handle, float r, float g, float b, float a) :715
...
// private void UpdateImage() :562
void ImageView__UpdateImage_fn(ImageView* __this)
{
    __this->UpdateImage();
}

// private void UpdateImage(Fuse.Resources.FileImageSource fileImageSource) :614
...
// private void UpdateImage(Fuse.Resources.HttpImageSource http) :619
void ImageView__UpdateImage2_fn(ImageView* __this, ::g::Fuse::Resources::HttpImageSource* http)
{
    __this->UpdateImage2(http);
}

// private void UpdateImage(Fuse.Resources.MultiDensityImageSource multi) :634
void ImageView__UpdateImage3_fn(ImageView* __this, ::g::Fuse::Resources::MultiDensityImageSource* multi)
{
    __this->UpdateImage3(multi);
}

// public void UpdateImageTransform(float density, float2 origin, float2 scale, float2 drawSize) :639
...
// private float2 GetImageSize() [instance] :681
...
// private void set_ImageHandle(Fuse.Controls.Native.ImageHandle value) [instance] :595
...
// public void set_ImageSource(Fuse.Resources.ImageSource value) [instance] :535
...
// private void OnImageLoaded(Fuse.Controls.Native.ImageHandle handle) [instance] :624
...
// private void OnImageLoadFailed(Uno.Exception e) [instance] :629
...
// public void set_TintColor(float4 value) [instance] :555
...
// private void UpdateImage() [instance] :562
...
// private void UpdateImage(Fuse.Resources.FileImageSource fileImageSource) [instance] :614
...
// private void UpdateImage(Fuse.Resources.HttpImageSource http) [instance] :619
...
// private void UpdateImage(Fuse.Resources.MultiDensityImageSource multi) [instance] :634
void ImageView::UpdateImage3(::g::Fuse::Resources::MultiDensityImageSource* multi)
{
    ::g::Fuse::Diagnostics::Unsupported(::STRINGS[0/*"MultiDensit...*/], this, ::STRINGS[1/*"/usr/local/...*/], 636, ::STRINGS[2/*"UpdateImage"*/]);
}

// public void UpdateImageTransform(float density, float2 origin, float2 scale, float2 drawSize) [instance] :639
...
// private static void ClearImage(ObjC.Object imageViewHandle) [static] :735
...
// private static ObjC.Object Create() [static] :742
...
// private static ObjC.Object CreateImageView(ObjC.Object container) [static] :753
...
// private static float GetImageHeight(ObjC.Object handle) [static] :698
...
// private static float GetImageWidth(ObjC.Object handle) [static] :689
...
// public ImageView New() [static] :572
...
// private static void SetAnchorPoint(ObjC.Object handle) [static] :579
...
// private static void SetBounds(ObjC.Object handle, float x, float y, float w, float h) [static] :675
...
// private static void SetImage(ObjC.Object imageViewHandle, ObjC.Object uiImageHandle) [static] :707
...
// private static void SetTransform(ObjC.Object handle, float m11, float m12, float m13, float m14, float m21, float m22, float m23, float m24, float m31, float m32, float m33, float m34, float m41, float m42, float m43, float m44) [static] :658
...
// private static void SetTransform(ObjC.Object handle, float4x4 t) [static] :648
...
// private static ObjC.Object TintImage(ObjC.Object handle, float r, float g, float b, float a) [static] :715
