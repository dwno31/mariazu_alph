// This file was generated based on /usr/local/share/uno/Packages/Fuse.Text/1.2.1/implementation/$.uno.
...
static void CoreTextFont_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("/usr/local/share/uno/Packages/Fuse.Text/1.2.1/implementation/$.uno");
...
// internal CoreTextFont(Uno.IntPtr hbFace, Uno.IntPtr cgFont, ObjC.Object uiFont, int pixelSize) :106
...
// public override sealed float get_Ascender() :131
...
// private void CGFontRelease(Uno.IntPtr cgFont) :161
void CoreTextFont__CGFontRelease_fn(CoreTextFont* __this, void** cgFont)
{
    __this->CGFontRelease(*cgFont);
}

// public override sealed float get_Descender() :132
...
// private float GetAscender(ObjC.Object uiFont) :137
...
// private static Uno.IntPtr GetCTFont(ObjC.Object font) :212
void CoreTextFont__GetCTFont_fn(::g::ObjC::Object* font, void** __retval)
{
    *__retval = CoreTextFont::GetCTFont(font);
}

// private float GetDescender(ObjC.Object uiFont) :139
...
// private float GetLineHeight(ObjC.Object uiFont) :141
...
// internal CoreTextFont New(Uno.IntPtr hbFace, Uno.IntPtr cgFont, ObjC.Object uiFont, int pixelSize) :106
...
// public override sealed int get_NumGlyphs() :134
...
// public override sealed int get_PixelSize() :102
void CoreTextFont__get_PixelSize_fn(CoreTextFont* __this, int* __retval)
{
    return *__retval = __this->_pixelSize, void();
}

// public override sealed Fuse.Text.RenderedGlyph Render(Fuse.Text.Glyph glyph) :145
...
// private byte[] Render(Uno.IntPtr rawFont, uint index, int2& size, float2& offset) :167
...
// protected override sealed float get_Scale() :103
void CoreTextFont__get_Scale_fn(CoreTextFont* __this, float* __retval)
{
    return *__retval = 64.0f, void();
}

// private static byte[] TryConvertRGBAToL8(byte[] buffer) :217
void CoreTextFont__TryConvertRGBAToL8_fn(uArray* buffer, uArray** __retval)
{
    *__retval = CoreTextFont::TryConvertRGBAToL8(buffer);
}

// internal CoreTextFont(Uno.IntPtr hbFace, Uno.IntPtr cgFont, ObjC.Object uiFont, int pixelSize) [instance] :106
void CoreTextFont::ctor_2(void* hbFace, void* cgFont, ::g::ObjC::Object* uiFont, int pixelSize)
{
...
// private void CGFontRelease(Uno.IntPtr cgFont) [instance] :161
...
// private float GetAscender(ObjC.Object uiFont) [instance] :137
...
// private float GetDescender(ObjC.Object uiFont) [instance] :139
...
// private float GetLineHeight(ObjC.Object uiFont) [instance] :141
...
// private int GetNumGlyphs(Uno.IntPtr cgFont) [instance] :142
int CoreTextFont::GetNumGlyphs(void* cgFont)
{
    return (int)CGFontGetNumberOfGlyphs((CGFontRef)cgFont);
}

// private byte[] Render(Uno.IntPtr rawFont, uint index, int2& size, float2& offset) [instance] :167
...
// private static Uno.IntPtr GetCTFont(ObjC.Object font) [static] :212
...
// internal CoreTextFont New(Uno.IntPtr hbFace, Uno.IntPtr cgFont, ObjC.Object uiFont, int pixelSize) [static] :106
CoreTextFont* CoreTextFont::New1(void* hbFace, void* cgFont, ::g::ObjC::Object* uiFont, int pixelSize)
{
...
// private static byte[] TryConvertRGBAToL8(byte[] buffer) [static] :217
uArray* CoreTextFont::TryConvertRGBAToL8(uArray* buffer)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 == 0, ::STRINGS[0/*"(buffer.Len...*/], ::STRINGS[1/*"/usr/local/...*/], 220, uArray::Init<uObject*>(::TYPES[0/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert1), uBox<int>(::g::Uno::Int_typeof(), 0)));
