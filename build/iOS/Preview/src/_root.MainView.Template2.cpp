...
{
    MainView__Template2::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"outlink"*/]);
}

static void MainView__Template2_build(uType* type)
{
    ::STRINGS[0] = uString::Const("outlink");
    type->SetFields(2,
...
void MainView__Template2__New1_fn(MainView__Template2* __this, uObject** __retval)
{
    ...
    ::g::OutLink* __self1 = ::g::OutLink::New5(uPtr(__this->__parent1)->router);
    __self1->Name(MainView__Template2::__selector0());
