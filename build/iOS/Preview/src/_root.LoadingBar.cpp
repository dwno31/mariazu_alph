// This file was generated based on /Users/daewonnoh/Fuse/mariazu_alpha/build/iOS/Preview/cache/ux11/LoadingBar.g.uno.
...
// public partial sealed class LoadingBar :2
// {
// static LoadingBar() :4
static void LoadingBar__cctor_4_fn(uType* __type)
{
}

static void LoadingBar_build(uType* type)
{
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)LoadingBar__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Panel_type* LoadingBar_typeof()
{
    ...
    options.ObjectSize = sizeof(LoadingBar);
    options.TypeSize = sizeof(::g::Fuse::Controls::Panel_type);
    type = (::g::Fuse::Controls::Panel_type*)uClassType::New("LoadingBar", options);
    type->fp_build_ = LoadingBar_build;
    type->fp_ctor_ = (void*)LoadingBar__New4_fn;
    type->fp_cctor_ = LoadingBar__cctor_4_fn;
...
// public LoadingBar() :8
void LoadingBar__ctor_7_fn(LoadingBar* __this)
{
    __this->ctor_7();
}

// private void InitializeUX() :12
void LoadingBar__InitializeUX_fn(LoadingBar* __this)
{
    __this->InitializeUX();
}

// public LoadingBar New() :8
void LoadingBar__New4_fn(LoadingBar** __retval)
{
    *__retval = LoadingBar::New4();
}

// public LoadingBar() [instance] :8
void LoadingBar::ctor_7()
{
    ctor_6();
    InitializeUX();
}
...
void LoadingBar::InitializeUX()
{
    uStackFrame __("LoadingBar", "InitializeUX()");
    Color(::g::Uno::Float4__New2(0.7333333f, 0.8784314f, 0.7411765f, 1.0f));
    Width(::g::Uno::UX::Size__New1(0.0f, 4));
    Height(::g::Uno::UX::Size__New1(2.0f, 1));
    Alignment(5);
}

// public LoadingBar New() [static] :8
LoadingBar* LoadingBar::New4()
{
    LoadingBar* obj1 = (LoadingBar*)uNew(LoadingBar_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
