...
{
    MainView__Template::__selector0_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[0/*"Splash"*/]);
}

static void MainView__Template_build(uType* type)
{
    ::STRINGS[0] = uString::Const("Splash");
    type->SetFields(2,
...
void MainView__Template__New1_fn(MainView__Template* __this, uObject** __retval)
{
    ...
    ::g::Splash* __self1 = ::g::Splash::New5(uPtr(__this->__parent1)->router);
    __self1->Name(MainView__Template::__selector0());
