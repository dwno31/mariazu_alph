...
// /Users/daewonnoh/Library/Application Support/Fusetools/Packages/Fuse.Launcher.Email/1.2.1/email/$.uno
// -----------------------------------------------------------------------------------------------------
...
static void EmailLauncher_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction("LaunchEmail", NULL, (void*)EmailLauncher__LaunchEmail_fn, 0, true, uVoid_typeof(), 5, ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), ::g::Uno::String_typeof(), ::g::Uno::String_typeof()));
}
...
{
    uStackFrame __("Fuse.LauncherImpl.EmailLauncher", "LaunchEmail(string,string,string,string,string)");
...
// /Users/daewonnoh/Library/Application Support/Fusetools/Packages/Fuse.Launcher.InterApp/1.2.1/interapp/$.uno
// -----------------------------------------------------------------------------------------------------------
...
// /Users/daewonnoh/Library/Application Support/Fusetools/Packages/Fuse.Launcher.Maps/1.2.1/maps/$.uno
// ---------------------------------------------------------------------------------------------------
...
static void MapsLauncher_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(3,
        new uFunction("LaunchMaps", NULL, (void*)MapsLauncher__LaunchMaps_fn, 0, true, uVoid_typeof(), 2, ::TYPES[0/*double*/], ::TYPES[0/*double*/]),
        new uFunction("LaunchMaps", NULL, (void*)MapsLauncher__LaunchMaps1_fn, 0, true, uVoid_typeof(), 3, ::TYPES[0/*double*/], ::TYPES[0/*double*/], ::g::Uno::String_typeof()),
        new uFunction("LaunchMaps", NULL, (void*)MapsLauncher__LaunchMaps2_fn, 0, true, uVoid_typeof(), 1, ::g::Uno::String_typeof()));
}
...
{
    uStackFrame __("Fuse.LauncherImpl.MapsLauncher", "LaunchMaps(double,double)");
...
{
    uStackFrame __("Fuse.LauncherImpl.MapsLauncher", "LaunchMaps(double,double,string)");
    uString* latlon = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Double::ToString(latitude, ::TYPES[0/*double*/]), ::STRINGS[8/*","*/]), ::g::Uno::Double::ToString(longitude, ::TYPES[0/*double*/]));
...
{
    uStackFrame __("Fuse.LauncherImpl.MapsLauncher", "LaunchMaps(string)");
    query = ::g::Uno::Net::Http::Uri::Encode(query);
    ::g::Fuse::iOS::Bindings::iOSDeviceInterop::LaunchUriiOS(::g::Uno::String::op_Addition2(::STRINGS[9/*"http://maps...*/], query));
}
// }

// /Users/daewonnoh/Library/Application Support/Fusetools/Packages/Fuse.Launcher.Phone/1.2.1/phone/$.uno
// -----------------------------------------------------------------------------------------------------
...
{
    type->Reflection.SetFunctions(1,
        new uFunction("LaunchCall", NULL, (void*)PhoneLauncher__LaunchCall_fn, 0, true, uVoid_typeof(), 1, ::g::Uno::String_typeof()));
}
...
{
    uStackFrame __("Fuse.LauncherImpl.PhoneLauncher", "LaunchCall(string)");
