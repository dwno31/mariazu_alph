...
// public sealed extern class Slider :1981
// {
...
// public Slider(Fuse.Controls.Native.IRangeViewHost host, Fuse.Visual visual) :1996
...
// public override sealed void Dispose() :2004
...
// private static float GetValue(ObjC.Object handle) :2035
void Slider__GetValue_fn(::g::ObjC::Object* handle, float* __retval)
{
    *__retval = Slider::GetValue(handle);
}

// public Slider New(Fuse.Controls.Native.IRangeViewHost host, Fuse.Visual visual) :1996
void Slider__New3_fn(uObject* host, ::g::Fuse::Visual* visual, Slider** __retval)
{
    *__retval = Slider::New3(host, visual);
}

// private void OnValueChanged(ObjC.Object sender, ObjC.Object uiEvent) :2023
...
// public void set_Progress(double value) :1986
void Slider__set_Progress_fn(Slider* __this, double* value)
{
    __this->Progress(*value);
}

// private static void SetValue(ObjC.Object handle, float value) :2042
void Slider__SetValue_fn(::g::ObjC::Object* handle, float* value)
{
    Slider::SetValue(handle, *value);
}

// private float get_Value() :2030
void Slider__get_Value_fn(Slider* __this, float* __retval)
{
    *__retval = __this->Value();
}

// private void set_Value(float value) :2031
void Slider__set_Value_fn(Slider* __this, float* value)
{
    __this->Value(*value);
}

// public Slider(Fuse.Controls.Native.IRangeViewHost host, Fuse.Visual visual) [instance] :1996
...
// private void OnValueChanged(ObjC.Object sender, ObjC.Object uiEvent) [instance] :2023
...
// public void set_Progress(double value) [instance] :1986
void Slider::Progress(double value)
{
    Value((float)value * 100.0f);
}

// private float get_Value() [instance] :2030
float Slider::Value()
{
    return Slider::GetValue(Handle());
}

// private void set_Value(float value) [instance] :2031
...
// private static float GetValue(ObjC.Object handle) [static] :2035
...
// public Slider New(Fuse.Controls.Native.IRangeViewHost host, Fuse.Visual visual) [static] :1996
...
// private static void SetValue(ObjC.Object handle, float value) [static] :2042
