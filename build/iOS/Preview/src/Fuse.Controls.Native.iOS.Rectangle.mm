...
// internal sealed extern class Rectangle :1507
// {
...
// public generated Rectangle() :1507
void Rectangle__ctor_5_fn(Rectangle* __this)
{
    __this->ctor_5();
}

// private void AddArcWithCenter(ObjC.Object handle, float centerX, float centerY, float radius, float startAngle, float endAngle) :1590
...
// private static ObjC.Object CreateUIBezierPath() :1563
void Rectangle__CreateUIBezierPath_fn(::g::ObjC::Object** __retval)
{
    *__retval = Rectangle::CreateUIBezierPath();
}

// private void Fuse.Controls.Native.IRectangleView.set_CornerRadius(float4 value) :1512
...
// private void AddArcWithCenter(ObjC.Object handle, float centerX, float centerY, float radius, float startAngle, float endAngle) [instance] :1590
...
// private void AddLineToPoint(ObjC.Object handle, float x, float y) [instance] :1583
...
// private void ClosePath(ObjC.Object handle) [instance] :1569
...
// private void MoveToPoint(ObjC.Object handle, float x, float y) [instance] :1576
...
// private static ObjC.Object CreateUIBezierPath() [static] :1563
...
// public generated Rectangle New() [static] :1507
