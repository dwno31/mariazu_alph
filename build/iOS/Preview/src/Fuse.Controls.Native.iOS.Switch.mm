...
// public sealed extern class Switch :2069
// {
...
// public Switch(Fuse.Controls.Native.IToggleViewHost host) :2081
void Switch__ctor_5_fn(Switch* __this, uObject* host)
{
    __this->ctor_5(host);
}

// private static ObjC.Object Create() :2101
void Switch__Create_fn(::g::ObjC::Object** __retval)
{
    *__retval = Switch::Create();
}

// public override sealed void Dispose() :2087
...
// private static bool GetValue(ObjC.Object handle) :2107
void Switch__GetValue_fn(::g::ObjC::Object* handle, bool* __retval)
{
    *__retval = Switch::GetValue(handle);
}

// public Switch New(Fuse.Controls.Native.IToggleViewHost host) :2081
void Switch__New3_fn(uObject* host, Switch** __retval)
{
    *__retval = Switch::New3(host);
}

// private void OnValueChanged(ObjC.Object sender, ObjC.Object uiEvent) :2095
...
// private static void SetValue(ObjC.Object handle, bool value) :2114
void Switch__SetValue_fn(::g::ObjC::Object* handle, bool* value)
{
    Switch::SetValue(handle, *value);
}

// public void set_Value(bool value) :2074
void Switch__set_Value_fn(Switch* __this, bool* value)
{
    __this->Value(*value);
}

// public Switch(Fuse.Controls.Native.IToggleViewHost host) [instance] :2081
...
// private void OnValueChanged(ObjC.Object sender, ObjC.Object uiEvent) [instance] :2095
...
// public void set_Value(bool value) [instance] :2074
void Switch::Value(bool value)
{
    Switch::SetValue(Handle(), value);
}

// private static ObjC.Object Create() [static] :2101
...
// private static bool GetValue(ObjC.Object handle) [static] :2107
...
// public Switch New(Fuse.Controls.Native.IToggleViewHost host) [static] :2081
...
// private static void SetValue(ObjC.Object handle, bool value) [static] :2114
