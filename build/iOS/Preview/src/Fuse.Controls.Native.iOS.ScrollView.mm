...
// public sealed extern class ScrollView :1617
// {
static void ScrollView_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(3,
        ...
        new uFunction(".ctor", NULL, (void*)ScrollView__New3_fn, 0, true, type, 1, ::TYPES[1/*Fuse.Controls.Native.IScrollViewHost*/]),
...
// public ScrollView(Fuse.Controls.Native.IScrollViewHost host) :1633
void ScrollView__ctor_4_fn(ScrollView* __this, uObject* host)
{
    __this->ctor_4(host);
}

// private static ObjC.Object AddCallback(ObjC.Object handle, Uno.Action<ObjC.Object> callback) :1655
...
// private static void GetContentOffset(ObjC.Object handle, float& x, float& y) :1688
void ScrollView__GetContentOffset_fn(::g::ObjC::Object* handle, float* x, float* y)
{
    ScrollView::GetContentOffset(handle, x, y);
}

// public ScrollView New(Fuse.Controls.Native.IScrollViewHost host) :1633
void ScrollView__New3_fn(uObject* host, ScrollView** __retval)
{
    *__retval = ScrollView::New3(host);
}

// private void OnScrollViewDidScroll(ObjC.Object scrollViewHandle) :1664
...
// public void set_AllowedScrollDirections(Fuse.Controls.ScrollDirections value) [instance] :1624
void ScrollView::AllowedScrollDirections(int value)
{
}

// private void OnScrollViewDidScroll(ObjC.Object scrollViewHandle) [instance] :1664
...
// public void set_ScrollPosition(float2 value) [instance] :1629
void ScrollView::ScrollPosition(::g::Uno::Float2 value)
{
    ScrollView::SetContentOffset(Handle(), value.X, value.Y);
}

// private static ObjC.Object AddCallback(ObjC.Object handle, Uno.Action<ObjC.Object> callback) [static] :1655
...
// private static ObjC.Object Create() [static] :1646
...
// private static void GetContentOffset(ObjC.Object handle, float& x, float& y) [static] :1688
...
// public ScrollView New(Fuse.Controls.Native.IScrollViewHost host) [static] :1633
...
// private static void SetContentOffset(ObjC.Object handle, float x, float y) [static] :1678
...
// private static void SetContentSize(ObjC.Object handle, float w, float h) [static] :1697
