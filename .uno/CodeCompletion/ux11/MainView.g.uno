...
public partial class MainView: Fuse.App
{
    ...
    public partial class Template2: Uno.UX.Template
    {
        [Uno.WeakReference] internal readonly MainView __parent;
        [Uno.WeakReference] internal readonly MainView __parentInstance;
        public Template2(MainView parent, MainView parentInstance): base("outlink", false)
        {
            __parent = parent;
            __parentInstance = parentInstance;
        }
        ...
        public override object New()
        {
            var __self = new global::OutLink(__parent.router);
            __self.Name = __selector0;
            return __self;
        }
        static global::Uno.UX.Selector __selector0 = "outlink";
    }
    internal global::Fuse.UserEvent myGlobalEvent;
    ...
    void InitializeUX()
    {
        ...
        var temp21 = new global::Device();
        myGlobalEvent = new global::Fuse.UserEvent();
        ...
        var outlink = new Template2(this, this);
        this.Background = float4(1f, 1f, 1f, 1f);
        myGlobalEvent.Name = __selector0;
        ...
        temp23.Templates.Add(outlink);
        this.Children.Add(myGlobalEvent);
        this.Children.Add(router);
        this.Children.Add(temp22);
    }
    static global::Uno.UX.Selector __selector0 = "myGlobalEvent";
